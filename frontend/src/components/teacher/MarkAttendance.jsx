...
const MarkAttendance = ({ classrooms, subjects }) => {
  ...
  const startSession = async () => {
    try {
      ...
      const response = await apiClient.post('/session/start', formData); // ✅ using apiClient
  ...
  const terminateSession = async () => {
    try {
      await stopAdvertising();
      await apiClient.patch(`/session/terminate/${activeSession.sessionId}`); // ✅ using apiClient
